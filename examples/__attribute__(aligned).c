...
typedef struct __attribute__((aligned(sizeof(unsigned long)))) {
	char pad1;
	char pad2;
	int b;
	int c;
...
int  main(void)
{
	...
	printf("sizeof(struct mystruct1) = %d.\n", sizeof(struct mystruct1));    //默认对齐时是8字节
        ...
        printf("sizeof(struct vec_header3_t) = %d.\n", sizeof(vec_header3_t));
        printf("sizeof(struct vec_header4_t) = %d.\n", sizeof(vec_header4_t));
